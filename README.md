...
| **분석 기간** | 2020-01-01 ~ 2025-12-31 (6개년, 약 1,500 거래일) |
...
삼성전자는 KOSPI와 강하게 동조하나 2020년(r=0.84)에서 2023년(r=0.66) 최저 후 2024~2025년(r=0.75) 수준으로 유지.
...
### 4. SK하이닉스가 삼성전자를 압도 (6년 누적: +631% vs +153%)

![인사이트4](data/processed/insight4_samsung_vs_skhynix.png)

HBM(고대역폭메모리) 수혜로 SK하이닉스가 2023~2025년 크게 아웃퍼폼.
...
1위 KOSPI (r=0.77) → 2위 SK하이닉스 (r=0.62) → 3위 NAVER (r=0.35) → 4위 USD/KRW (r=-0.14) → 5위 S&P500 (r=0.13)
